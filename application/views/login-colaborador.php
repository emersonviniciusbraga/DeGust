...
<html lang="pt">
  ...
  <body class="text-center" style="background: #28a745">
    <form class="form-signin" method="post" action="<?= base_url()?>index.php/LoginColaborador/storeColaborador">
      ...
      <p>
        <a href="<?= base_url()?>index.php/SignupColaborador">Não tem uma conta?</a>
      </p>
