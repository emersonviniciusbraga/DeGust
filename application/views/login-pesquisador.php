...
<html lang="pt">
  ...
  <body class="text-center" style="background: #28a745">
    ...
    <form class="form-signin" method="post" action="<?= base_url()?>loginpesquisador/loginSUAP">
      ...
      <br><br>
      <h1 class="h3 mb-3 font-weight-normal">Login Pesquisador</h1>
      
      <label for="inputMatricula" class="sr-only">Matricula</label>

      <input  type="text" name="matricula" id="inputMatricula" class="form-control" placeholder="Matricula" required autofocus>
      ...
      <p class="mt-5 mb-3">DeGust&copy;Todos os direitos reservados.</p>
    </form>
